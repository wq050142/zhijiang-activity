      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md border-b border-[#4A3728]/10 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link href="/services/custom" className="text-[#C9A86C] font-medium">定制活动</Link>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center border border-[#4A3728]/10">
                <div className="text-3xl font-bold text-[#C9A86C] mb-1">300+</div>
                <div className="text-sm text-[#4A3728]/60">定制活动</div>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center border border-[#4A3728]/10">
                <div className="text-3xl font-bold text-[#C9A86C] mb-1">99%</div>
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-[#4A3728]">服务范围</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#4A3728]/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4A3728]">高端商务活动</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#4A3728]/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4A3728]">品牌发布会</h3>
              <p className="text-[#4A3728]/70 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#4A3728]/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4A3728]">VIP客户答谢</h3>
              <p className="text-[#4A3728]/70 leading-relaxed">
