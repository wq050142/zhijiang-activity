            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col items-center gap-3 p-4 rounded-lg bg-gradient-to-br from-[#FFE15D]/8 to-[#FFC107]/4 border border-[#FFE15D]/20 hover:from-[#FFE15D]/12 hover:border-[#FFE15D]/40 transition-all text-center">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-[#2D2D2D] mb-1">高端格调</h3>
                    <p className="text-[#6B7280] text-xs leading-relaxed">文化地标加持，彰显品牌实力</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 p-4 rounded-lg bg-gradient-to-br from-[#FFE15D]/8 to-[#FFC107]/4 border border-[#FFE15D]/20 hover:from-[#FFE15D]/12 hover:border-[#FFE15D]/40 transition-all text-center">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-[#2D2D2D] mb-1">尊享体验</h3>
                    <p className="text-[#6B7280] text-xs leading-relaxed">私人导览服务，一对一专属服务</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 p-4 rounded-lg bg-gradient-to-br from-[#FFE15D]/8 to-[#FFC107]/4 border border-[#FFE15D]/20 hover:from-[#FFE15D]/12 hover:border-[#FFE15D]/40 transition-all text-center">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-[#2D2D2D] mb-1">专业策划</h3>
                    <p className="text-[#6B7280] text-xs leading-relaxed">从策划到执行，全流程专业服务</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 p-4 rounded-lg bg-gradient-to-br from-[#FFE15D]/8 to-[#FFC107]/4 border border-[#FFE15D]/20 hover:from-[#FFE15D]/12 hover:border-[#FFE15D]/40 transition-all text-center">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-[#2D2D2D] mb-1">品质保障</h3>
                    <p className="text-[#6B7280] text-xs leading-relaxed">一流团队执行，确保完美呈现</p>
                  </div>
                </div>
              </div>
            </div>
