...
export default function TeamPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F1E8]">
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md border-b border-[#4A3728]/10 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link href="/services/team" className="text-[#C9A86C] font-medium">团建拓展</Link>
      ...
      {/* Banner区域 */}
      <section className="pt-32 pb-12 px-6 bg-gradient-to-br from-[#8B4513] to-[#C9A86C]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center border border-[#4A3728]/10">
                <div className="text-3xl font-bold text-[#C9A86C] mb-1">800+</div>
                <div className="text-sm text-[#4A3728]/60">团建活动</div>
              </div>
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center border border-[#4A3728]/10">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#4A3728]/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4A3728]">文化沉浸体验</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#4A3728]/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4A3728]">非遗手作体验</h3>
              <p className="text-[#4A3728]/70 mb-6 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-[#4A3728]/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-[#4A3728]">人文团队共创</h3>
              <p className="text-[#4A3728]/70 mb-6 leading-relaxed">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-gradient-to-br from-[#8B4513] to-[#C9A86C] rounded-xl p-6 text-white">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-4 py-3 rounded-lg border border-[#4A3728]/20 focus:border-[#C9A86C] outline-none resize-none" placeholder="请详细描述您的活动需求..." value={formData.requirements} onChange={(e) => setFormData({ ...formData, requirements: e.target.value })}></textarea>
                </div>
