      ...
      <section className="py-12 px-4 md:px-6 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-8 lg:items-start mb-8">
            ...
            <div className="lg:col-span-6">
              {/* 主图片 */}
              <div className="mx-auto lg:max-w-full aspect-[4/3] lg:aspect-[16/9] rounded-3xl overflow-hidden shadow-2xl relative">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 md:mb-14">
            <div className="inline-flex items-center gap-2 mb-3 md:mb-4">
              ...
              <span className="text-[#FF9F43] font-semibold text-sm md:text-base">资源体系</span>
            </div>
            <h2 className="text-2xl md:text-4xl font-bold mb-3 md:mb-4 text-[#333333]">
              丰富的资源体系
            </h2>
            <p className="text-sm md:text-lg text-[#666666] max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
              {/* 主图 */}
              <div className="aspect-[16/9] relative overflow-hidden">
                <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url("/会议活动资源主图.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4">
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="aspect-square rounded-lg overflow-hidden bg-gray-100">
                    <img src="/会议活动资源4.png" alt="会议活动" className="w-full h-full object-cover" />
                  </div>
                  <div className="aspect-square rounded-lg overflow-hidden bg-gray-100">
                    <img src="/会议活动资源5.png" alt="会议活动" className="w-full h-full object-cover" />
                  </div>
                  <div className="aspect-square rounded-lg overflow-hidden bg-gray-100">
