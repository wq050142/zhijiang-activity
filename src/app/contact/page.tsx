      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md border-b border-[#4A3728]/10 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link href="/contact" className="text-[#C9A86C] font-medium">联系我们</Link>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* 联系表单 */}
            <div>
              <h2 className="text-4xl font-bold mb-6 text-[#4A3728]">在线留言</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-[#4A3728] font-medium mb-2">活动类型</label>
                  <select
                    className="w-full px-4 py-3 rounded-lg border border-[#4A3728]/20 focus:border-[#C9A86C] focus:ring-2 focus:ring-[#C9A86C]/20 outline-none transition-all bg-white"
            ...
            {/* 联系信息 */}
            <div>
              <h2 className="text-4xl font-bold mb-6 text-[#4A3728]">联系方式</h2>

              <div className="space-y-6 mb-12">
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-[#4A3728]/10">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-[#4A3728] rounded-xl flex items-center justify-center flex-shrink-0">
                      <Phone className="h-7 w-7 text-white" />
                    </div>
                    <div>
                      <p className="text-[#4A3728]/60 text-sm mb-2">联系电话</p>
                      <a href="tel:191-0658-3798" className="text-2xl font-bold text-[#4A3728] hover:text-[#C9A86C] transition-colors">
                        191-0658-3798
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-[#4A3728]/10">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-[#C9A86C] rounded-xl flex items-center justify-center flex-shrink-0">
                      <Mail className="h-7 w-7 text-white" />
                    </div>
                    <div>
                      <p className="text-[#4A3728]/60 text-sm mb-2">电子邮箱</p>
                      <a href="mailto:service@zhijiang-culture.com" className="text-xl font-bold text-[#4A3728] hover:text-[#C9A86C] transition-colors">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-[#4A3728]/10">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-[#8B4513] rounded-xl flex items-center justify-center flex-shrink-0">
                      <MapPin className="h-7 w-7 text-white" />
                    </div>
                    <div>
                      <p className="text-[#4A3728]/60 text-sm mb-2">场馆地址</p>
              ...
              <div className="bg-[#4A3728] rounded-2xl p-8 text-white">
